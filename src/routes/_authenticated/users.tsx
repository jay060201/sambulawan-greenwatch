          ...
          <div className="overflow-x-auto rounded-md border border-border">
            <table className="w-full text-sm">
              <thead className="bg-muted/50 text-left text-xs uppercase text-muted-foreground">
                <tr><th className="p-3">Full Name</th><th>Username</th><th>Status</th><th>Role</th><th>Joined</th></tr>
              </thead>
              <tbody>
                {isLoading ? (
                  ...
                  <tr key={u.id} className="border-t border-border">
                    ...
                    <td><span className="rounded-full bg-[color:var(--success)]/15 px-2 py-0.5 text-xs capitalize text-[color:var(--success)]">{u.status}</span></td>
                    <td>
